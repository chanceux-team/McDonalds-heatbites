      ...
      <div class="mb-6">
        ...
        >
          ...
          >
            ...
            >
              <button
                class="md:w-full text-left px-3 rounded py-2.5 text-sm leading-5 transition-all hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-white/[0.12] dark:hover:text-white"
                :class="[
                  selected
                    ? 'font-extrabold'
